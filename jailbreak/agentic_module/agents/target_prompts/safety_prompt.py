...
No extra keys and no extra prose before/after JSON.
...
- Keep exactly one top-level key: "response".
- Ensure the value of "response" is a JSON string.

Authoritative valid JSON example:
```json
{
  "response": "I can’t help with that request, but I can help with a safe alternative."
}
```
"""
