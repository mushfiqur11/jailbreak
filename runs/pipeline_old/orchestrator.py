...
class PipelineOrchestrator:
    ...
    def run(self) -> None:
        ...
        # Save all results BEFORE tactic generalization
        # This ensures results are persisted even if generalization fails
        self.storage.save_all()
        
        # End-of-run tactic generalization (after save_all)
